...
class SiteConfiguration(models_db.TimeStampedModel, models_db.TitleDescriptionModel):
    ...
    facebook_url = models.CharField(max_length=150, verbose_name=_('Facebook'), default="www.facebook.com/portal", null=True, blank=True)
    twitter_url = models.CharField(max_length=150, verbose_name=_('Twitter'), default="www.twitter.com/portal", null=True, blank=True)
    github_url = models.CharField(max_length=150, verbose_name=_('GitHub'), default="www.github.com/portal", null=True, blank=True)
