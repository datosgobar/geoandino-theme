...
define(function (require, exports) {
    ...
    LayerInfo.prototype.markStart = function () {
        var message = window.gettext("Your upload has started")

        this.logStatus({
            msg: message + '<div class="progress" id="prog"><div class="progress-bar progress-bar-success" style="width:0%"></div>',
            level: 'alert-success',
            empty: 'true'
        });
    };
